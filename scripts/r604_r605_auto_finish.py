#!/usr/bin/env python3
"""Auto-finish script for R604 (E5189-E5191) and R605 (E5192-E5194)."""
...
def process_round(round_number, experiment_ids, started_at):
    """Wait for experiments to finish, analyze, promote, save round."""
    ...
    api_post('lab/exploration-rounds', {
        ...
        "insights": [f"R{round_number} BelMax deep exploration"],
        "promoted": [],
        "issues_resolved": [],
        "next_suggestions": [],
        "summary": summary,
...
def main():
    ...
    # R604
    print("=== Processing R604 ===")
    stda604, valid604 = process_round(604, [5189, 5190, 5191], now)

    # R605
    print("\n=== Processing R605 ===")
    stda605, valid605 = process_round(605, [5192, 5193, 5194], now)

    # R606
    print("\n=== Processing R606 ===")
    stda606, valid606 = process_round(606, [5195, 5196, 5197], now)

    print(f"\nTotal: R604={stda604}/{valid604}, R605={stda605}/{valid605}, R606={stda606}/{valid606}")
