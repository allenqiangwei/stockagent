#!/usr/bin/env python3
"""Auto-finish script for R608 (E5202-E5205) and R609 (E5206-E5209)."""
...
def process_round(round_number, experiment_ids, started_at):
    ...
    summary = f"R{round_number}: {valid} strategies, {stda_count} StdA+ ({stda_count * 100 // max(valid, 1)}%)"
    print(summary)
...
def main():
    ...
    print("=== R608 ===")
    s608, v608 = process_round(608, [5202, 5203, 5204, 5205], now)
    print("\n=== R609 ===")
    s609, v609 = process_round(609, [5206, 5207, 5208, 5209], now)
    print(f"\nTotal: R608={s608}/{v608}, R609={s609}/{v609}")
