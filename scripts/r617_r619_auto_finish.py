#!/usr/bin/env python3
"""Auto-finish script for R617 (E5225), R618 (E5226), R619 (E5227)."""
...
def main():
    ...
    print("=== Processing R617 ===")
    stda617, valid617 = process_round(617, [5225], now, ["Position size exploration on BelMax"])

    print("\n=== Processing R618 ===")
    stda618, valid618 = process_round(618, [5226], now, ["Asymmetric Abv/Bel window combinations"])

    print("\n=== Processing R619 ===")
    stda619, valid619 = process_round(619, [5227], now, ["Rise/volume momentum as 5th buy condition"])

    print(f"\nTotal: R617={stda617}/{valid617}, R618={stda618}/{valid618}, R619={stda619}/{valid619}")
