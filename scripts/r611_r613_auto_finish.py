#!/usr/bin/env python3
"""Auto-finish script for R611 (E5213-E5214), R612 (E5215-E5216), R613 (E5217-E5218)."""
...
def main():
    ...
    print("=== Processing R611 ===")
    stda611, valid611 = process_round(611, [5213, 5214],
        now, ["MHD/SL grid on BelMax18 strategy"], ["Optimize winning MHD/SL combos"])

    print("\n=== Processing R612 ===")
    stda612, valid612 = process_round(612, [5215, 5216],
        now, ["BelMax window (10-20) and AbvMin window (8-20) exploration"], ["Find optimal lookback window pair"])

    print("\n=== Processing R613 ===")
    stda613, valid613 = process_round(613, [5217, 5218],
        now, ["RSI range and ATR threshold exploration on BelMax combo"], ["Refine RSI/ATR for BelMax strategies"])

    print(f"\nTotal: R611={stda611}/{valid611}, R612={stda612}/{valid612}, R613={stda613}/{valid613}")
