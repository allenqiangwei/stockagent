#!/usr/bin/env python3
"""Auto-finish script for R607 (E5198-E5201)."""
...
def main():
    ...
    experiment_ids = [5198, 5199, 5200, 5201]
    ...
    summary = f"R607: {valid} strategies, {stda_count} StdA+ ({stda_count * 100 // max(valid, 1)}%). Best: {best_name} score={best_score:.4f} ret={best_return:.1f}%"
    print(summary)
    ...
    api_post('lab/exploration-rounds', {
        ...
        "insights": ["ULCER/CCI/StochRSI filters on RSI+ATR base", "DIP pct_change as buy condition"],
        "promoted": [],
        "issues_resolved": [],
        "next_suggestions": ["Explore KELTNER filter", "Test BOLL%B as buy condition"],
        "summary": summary,
        "memory_synced": False,
