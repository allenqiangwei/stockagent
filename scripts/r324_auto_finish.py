#!/usr/bin/env python3
"""R324 Auto-Finish: Poll E4418, promote StdA+, update exploration round."""
import subprocess, json, time, urllib.parse
from datetime import datetime

EXPERIMENT_ID = 4418
ROUND_ID = None  # Will be set after creation
ROUND_NUMBER = 324
STARTED_AT = "2026-03-07T00:25:00"
...
def main():
    ...
    for i in range(120):  # 2 hours max
    ...
    round_data = {
        ...
        "insights": ["R324 auto-finished by background script"],
        "promoted": promoted_list[:5],
        "issues_resolved": [],
        "next_suggestions": [],
        "summary": f"R324 (auto-finish): {valid} strategies, {stda_count} StdA+, best={best_score:.4f}",
        "memory_synced": False,
