...
> 更新时间: 2026-02-16 | 总实验: 195 | 总策略: 1378 | 有效(done): 885+ | 无效(invalid): 493+ | 盈利: 140+ (15.8%+) | Standard A: **31个** | 组合策略: 已实现 | 规则引擎P4: 已完成 | 克隆调参网格搜索: 已实现
...
33. **PSAR+BOLL+KDJ是第二强三维组合** — S1334(score 0.70, +27.5%, dd 8.2%, 428笔)达Standard A, 全阶段盈利(ranging+12/bull+151/bear+91)。PSAR趋势+BOLL波动位置+KDJ超卖是另一个有效三维组合。但DeepSeek field比较指令生成率极低(ID173: 2/8有效, ID171/172: 0/8)
...
| P2 | **PSAR三维** | **PSAR+BOLL%B+KDJ** | **已探索** | 1 | **100%** | **+27.5%** | **ID173: 2/8有效(6invalid), S1334达StdA(score 0.70, +27.5%, dd8.2%), 全阶段盈利!** |
...
| 3 | **PSAR趋势动量_SL10_TP15** | **0.779** | **+82.8%** | **14.7%** | — | **957** | **网格搜索新最佳! 宽止损+适中止盈** |
| 4 | 全指标综合_中性版C | 0.78 | +58.5% | 14.6% | 29.9% | 545 | P0修复 |
| 5 | PSAR趋势动量_SL8_TP10_v2 | 0.775 | +75.0% | 12.6% | — | 1062 | 网格搜索 |
| 6 | PSAR趋势动量_SL8_TP15_v2 | 0.772 | +77.5% | 14.8% | — | 962 | 网格搜索 |
| 7 | PSAR趋势动量_保守版A(原) | 0.77 | +70.8% | 12.6% | — | 1012 | 第十二轮(全阶段盈利) |
| 8 | PSAR趋势动量_SL10_TP20 | 0.762 | +68.8% | 15.2% | — | 924 | 网格搜索 |
| 9 | PSAR趋势动量_SL5_TP15 | 0.761 | +66.0% | 13.4% | — | 992 | 网格搜索 |
| 10 | 全指标综合_保守版B | 0.75 | +29.1% | 4.0% | 39.3% | 272 | P0修复 |
| 11 | 全指标综合_中性版C_紧止损5pct | 0.75 | +46.5% | 14.7% | — | 547 | 克隆调参 |
| 12 | UltimateOsc_中性版C | 0.72 | +28.0% | 11.2% | — | 262 | 批量重试 |
| 13 | PSAR+BOLL+KDJ_保守版B | 0.70 | +27.5% | 8.2% | — | 428 | 第十三轮(全阶段盈利) |
| 14 | KDJ金叉_中性版A | 0.70 | +37.1% | 9.8% | 47.5% | 810 | 第三轮 |
| 15 | KDJ金叉_激进版B | 0.70 | +31.5% | 9.1% | 45.2% | 641 | 第三轮 |
...
| P4 | 零交易~50% | **已修复** 2026-02-16 — 快速预扫描: 100股×60天检测买入信号, 零信号直接标invalid(~3s vs 5min) |
...
| P14 | 回测队列处理慢(~2并发) | **已修复** 2026-02-16 — threading.Semaphore(3)限制并发, 超时300s→600s |
